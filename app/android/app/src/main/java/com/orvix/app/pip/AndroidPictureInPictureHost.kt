...
import com.orvix.app.MainActivity
...
class AndroidPictureInPictureHost(private val activity: Activity) : PictureInPictureHost {
    ...
    private fun actions(playing: Boolean) = listOf(
        remoteAction(
            ...
            com.orvix.app.R.string.pip_rewind_10,
        ),
        remoteAction(
            PictureInPictureAction.TOGGLE_PLAYBACK,
            2,
            if (playing) android.R.drawable.ic_media_pause else android.R.drawable.ic_media_play,
            if (playing) com.orvix.app.R.string.pip_pause else com.orvix.app.R.string.pip_play,
        ),
        remoteAction(
            PictureInPictureAction.SEEK_FORWARD,
            3,
            android.R.drawable.ic_media_ff,
            com.orvix.app.R.string.pip_forward_10,
        ),
    )
