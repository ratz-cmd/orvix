...
internal class GoogleCastRemoteClient(
    ...
    override fun load(
        ...
        track(pending, {
            Log.w("OrvixCastDiag", "remote_load_cancelled")
            callback(Result.failure(IllegalStateException("ORVIX_CAST_COMMAND_CANCELLED")))
        }) {
            Log.i(
                "OrvixCastDiag",
            ...
            callback(it.status.asResult("ORVIX_CAST_LOAD_REJECTED"))
        }
    }
    ...
    override fun play(callback: (Result<Unit>) -> Unit) = runMain {
        ...
        track(pending, {
            ...
            callback(it.status.asResult("ORVIX_CAST_PLAY_FAILED"))
        }
    }
    ...
    override fun pause(callback: (Result<Unit>) -> Unit) = runMain {
        ...
        track(pending, {
            ...
            callback(it.status.asResult("ORVIX_CAST_PAUSE_FAILED"))
        }
    }
    ...
    override fun seekTo(seconds: Double, callback: (Result<Unit>) -> Unit) = runMain {
        ...
        track(pending, {
            ...
            callback(it.status.asResult("ORVIX_CAST_SEEK_FAILED"))
        }
    }
    ...
    override fun requestStatus(
        ...
        track(pending, {
            ...
            val result = it.status.asResult("ORVIX_CAST_STATUS_FAILED")
    ...
    override fun stop(callback: (Result<Unit>) -> Unit) = runMain {
        ...
        track(pending, {
            ...
            callback(it.status.asResult("ORVIX_CAST_STOP_FAILED"))
        }
    }
