...
import com.orvix.app.BuildConfig
import java.io.File
    ...
    fun enqueueDownload(url: String, fileName: String, title: String, promise: Promise) {
        try {
            ...
            val request = DownloadManager.Request(parsed)
                .setTitle(title)
                .setDescription("Téléchargement de la mise à jour Orvix")
    ...
    fun installApk(filePath: String, promise: Promise) {
        try {
            ...
            val intent = Intent(Intent.ACTION_VIEW).apply {
                ...
                clipData = ClipData.newRawUri("Orvix update", uri)
