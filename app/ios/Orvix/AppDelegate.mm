...
// Orvix-Swift.h declare toutes les classes @objc du module, dont CastModule
// (RCTEventEmitter <GCKRemoteMediaClientListener, GCKSessionManagerListener>),
// le controleur PiP et OrvixMediaSchemeHandler (WKURLSchemeHandler). Swift ne
