...
enum OrvixGlassMaterialChoice: Equatable {
  case liquidGlass
  case blur(UIBlurEffect.Style)
  case opaque
}

enum OrvixGlassMaterialResolver {
  static func resolve(
...
@objc(OrvixGlassEffectView)
final class OrvixGlassEffectView: UIView {
  ...
  private func rebuildEffect() {
    let choice = OrvixGlassMaterialResolver.resolve()
    switch choice {
    case .opaque:
  ...
  private func makeEffect(for choice: OrvixGlassMaterialChoice) -> UIVisualEffect? {
    switch choice {
    case .liquidGlass:
