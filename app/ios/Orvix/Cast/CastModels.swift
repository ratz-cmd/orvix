...
enum CastRelayError: String, Error, Equatable, Sendable {
  case invalidSource = "ORVIX_CAST_SOURCE_INVALID"
  case pickerDismissed = "ORVIX_CAST_PICKER_DISMISSED"
  case unsupportedContentType = "ORVIX_CAST_CONTENT_TYPE_UNSUPPORTED"
  case invalidTextTrack = "ORVIX_CAST_TEXT_TRACK_INVALID"
  case tooManyTracks = "ORVIX_CAST_TOO_MANY_TRACKS"
  case localSourceUnavailable = "ORVIX_CAST_LOCAL_SOURCE_UNAVAILABLE"
  case listenerUnavailable = "ORVIX_CAST_RELAY_UNAVAILABLE"
  case sessionUnavailable = "ORVIX_CAST_RELAY_SESSION_UNAVAILABLE"
  case capacityExceeded = "ORVIX_CAST_RELAY_CAPACITY_EXCEEDED"
  case invalidRequest = "ORVIX_CAST_RELAY_INVALID_REQUEST"
  case accessRevoked = "ORVIX_CAST_RELAY_ACCESS_REVOKED"
  case upstreamUnavailable = "ORVIX_CAST_RELAY_UPSTREAM_UNAVAILABLE"
  case responseTooLarge = "ORVIX_CAST_RELAY_RESPONSE_TOO_LARGE"
}
