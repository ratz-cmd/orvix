...
enum CastNetworkSelectionError: String, Error, Equatable, Sendable {
  case invalidReceiverAddress = "ORVIX_CAST_RECEIVER_ADDRESS_INVALID"
  case unusableReceiverAddress = "ORVIX_CAST_RECEIVER_ADDRESS_UNUSABLE"
  case noUsableWiFiRoute = "ORVIX_CAST_NO_WIFI_ROUTE"
}
...
final class CastNetworkPathMonitor: @unchecked Sendable {
  ...
  init(
    ...
    queue: DispatchQueue = DispatchQueue(label: "com.orvix.cast.network-path")
  ) {
