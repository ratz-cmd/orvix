...
const PersistenceManager = () => {
  ...
  useEffect(() => {
    ...
    if (supportsBroadcastChannel && isLocalStorageAvailable) {
      try {
        channel = new BroadcastChannel('orvix-storage-sync');
          ...
          <div className="bg-gray-900/95 backdrop-blur-md border border-gray-700/80 rounded-2xl shadow-2xl overflow-hidden">
            <div className="p-4">
              <div className="flex items-start gap-3 mb-3">
                <div className="w-10 h-10 rounded-full overflow-hidden ring-2 ring-blue-500/50 flex-shrink-0">
                  <img
...
const AppWithIntro: React.FC = () => {
  ...
  useEffect(() => {
    const IDLE_PREFETCH = ['/movies', '/tv-shows', '/search'];
...
const EmbedBlockPage = () => (
  <div className="flex flex-col items-center justify-center min-h-screen bg-black text-white p-4 text-center sm:p-6 lg:p-8">
    ...
    <div className="border-2 border-blue-700 bg-blue-950/60 rounded-lg p-6 max-w-md w-full shadow-lg sm:max-w-lg lg:max-w-2xl">
