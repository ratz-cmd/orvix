...
const ReportModal: React.FC<ReportModalProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const webhookUrl = import.meta.env.VITE_REPORT_DISCORD_WEBHOOK_URL;
      if (!webhookUrl) throw new Error('Report webhook is not configured');
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="p-4 bg-gray-800/50 rounded-lg">
                      <div className="mb-4">
                        ...
                        <select
                          ...
                          className="w-full bg-gray-800 text-white rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:outline-none"
                        >
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full bg-gray-800 text-white rounded-lg pl-10 pr-3 py-2 focus:ring-2 focus:ring-blue-500 focus:outline-none ${
                        !discordUsername.trim() && error ? 'border-2 border-blue-500' : ''
                      }`}
                    />
                  </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className={`w-full bg-gray-800 text-white rounded-lg px-3 py-2 h-24 focus:ring-2 focus:ring-blue-500 focus:outline-none resize-none ${
