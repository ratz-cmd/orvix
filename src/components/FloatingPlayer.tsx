          ...
          <div className="absolute bottom-0 left-0 right-0 p-3 space-y-2">
            ...
            <div className="w-full">
              <input
                ...
                onMouseDown={(e) => e.stopPropagation()}
                className="w-full h-1 bg-gray-600 rounded-lg appearance-none cursor-pointer [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:w-3 [&::-webkit-slider-thumb]:h-3 [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-blue-600 [&::-webkit-slider-thumb]:cursor-pointer [&::-moz-range-thumb]:w-3 [&::-moz-range-thumb]:h-3 [&::-moz-range-thumb]:rounded-full [&::-moz-range-thumb]:bg-blue-600 [&::-moz-range-thumb]:border-0 [&::-moz-range-thumb]:cursor-pointer hover:[&::-webkit-slider-thumb]:bg-blue-500 hover:[&::-moz-range-thumb]:bg-blue-500"
                style={{
                  background: `linear-gradient(to right, #2563eb 0%, #2563eb ${(playbackTime / (duration || 1)) * 100}%, #4b5563 ${(playbackTime / (duration || 1)) * 100}%, #4b5563 100%)`
                }}
              />
            </div>
