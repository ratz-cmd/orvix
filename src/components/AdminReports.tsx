...
const REASON_LABELS: Record<string, { labelKey: string; color: string }> = {
    ...
    harassment: { labelKey: 'admin.reasonHarassment', color: 'bg-blue-500' },
        ...
        <div className="space-y-6">
            ...
            {fetchError && (
                <div className="p-4 bg-blue-500/10 border border-blue-500/20 rounded-lg flex items-start gap-3">
                    ...
                    <div>
                        <p className="text-sm text-blue-200 font-medium">{t('errors.loadingFailed')}</p>
                        <p className="text-xs text-blue-100/70">{fetchError}</p>
                        <p className="text-xs text-blue-100/50 mt-1">{t('admin.reportsApiHint')}</p>
                    </div>
                </div>
            )}
                                        ...
                                        <div className="flex-1 min-w-0 space-y-3">
                                            ...
                                            <div className="flex flex-wrap items-center gap-2">
                                                ...
                                                {report.report_count > 1 && (
                                                    <Badge className="bg-blue-500/20 text-blue-400 text-[10px] px-2 py-0.5 border border-blue-500/30">
