          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <input
                ...
                className="w-full p-3 bg-gray-700 rounded-xl text-white placeholder-gray-400 focus:ring-2 focus:ring-blue-500 outline-none transition-colors border border-gray-600"
                autoFocus
              />
