          ...
          <>
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-3 rounded-xl bg-white/5 border border-white/10 text-white placeholder-white/30 focus:outline-none focus:border-blue-500/50 transition-colors"
                autoFocus
              />
              {query && (
              ...
              <AnimatePresence>
                {results.map((item, i) => (
                  <motion.button
                    ...
                    className="group relative rounded-xl overflow-hidden bg-white/5 border border-white/10 hover:border-blue-500/40 transition-all text-left"
                  >
                    <img
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 max-h-[400px] overflow-y-auto custom-scrollbar">
                {seasons.map((s, i) => (
                  <motion.button
                    ...
                    className="p-4 rounded-xl bg-white/5 border border-white/10 hover:border-blue-500/40 hover:bg-white/10 transition-all text-left"
                  >
              ...
              <div className="flex flex-col gap-2 max-h-[400px] overflow-y-auto custom-scrollbar">
                {episodes.map((ep, i) => (
                  <motion.button
                    ...
                    className="flex items-center gap-3 p-3 rounded-xl bg-white/5 border border-white/10 hover:border-blue-500/40 hover:bg-white/10 transition-all text-left group"
                  >
                    {ep.still_path ? (
                      <img
                    ...
                    <ArrowRight className="w-4 h-4 text-white opacity-20 group-hover:text-blue-400 group-hover:opacity-100 transition-[color,opacity] flex-shrink-0" />
                  </motion.button>
                ))}
              </div>
            )}
