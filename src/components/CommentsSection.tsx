  ...
  return (
    <button
      ...
      className={`flex items-center gap-2 transition-all duration-200 rounded-lg font-medium ${checked
        ? 'bg-blue-600/20 text-blue-400 border-2 border-blue-500/50 hover:bg-blue-600/30 hover:border-blue-500'
      ...
      <div className="flex items-start gap-2 sm:gap-3 md:gap-4">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-1.5 sm:gap-2 flex-wrap">
            ...
            {comment.is_admin === 1 && (
              <span className="px-1.5 sm:px-2 py-0.5 bg-blue-600 text-white text-[10px] sm:text-xs rounded-full whitespace-nowrap">
                Admin
              </span>
            )}
            {comment.is_vip === 1 && (
          ...
          {editingComment === comment.id ? (
            <div className="mt-2 sm:mt-3">
              <textarea
                ...
                maxLength={500}
                className="w-full bg-gray-700/50 text-white rounded-lg p-2 sm:p-3 text-sm sm:text-base focus:outline-none focus:ring-2 focus:ring-blue-600 resize-none"
                rows={3}
              />
              <MarkdownToolbar
            ...
            <div className="mt-2">
              ...
              {comment.is_spoiler === 1 && !revealedSpoilers.has(`comment-${comment.id}`) && (
                <motion.span
                  ...
                  animate={{ opacity: 1 }}
                  exit={{ opacity: 0 }}
                  className="inline-flex items-center gap-1 mt-1 sm:mt-2 text-[10px] sm:text-xs text-blue-400"
                >
          ...
          <div className="flex items-center gap-2 sm:gap-3 md:gap-4 mt-3 sm:mt-4 flex-wrap">
            <button
              ...
              className={`flex items-center gap-1 transition-colors ${comment.userReaction ? 'text-blue-500' : 'text-gray-400 hover:text-blue-500'
                }`}
            ...
            {(isAdmin || (profileId && profileId === comment.profile_id)) && (
              <button
                ...
                className="text-xs sm:text-sm text-blue-500 hover:text-blue-400 transition-colors flex items-center gap-1"
              >
                      ...
                      {replyingTo.username && (
                        <div className="flex items-center justify-between mb-2">
                          <span className="text-xs sm:text-sm text-gray-400">
                            {t('comments.replyTo')} <span className="text-blue-500">@{replyingTo.username}</span>
                          </span>
                          <button
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-1.5 sm:gap-2 flex-wrap">
                            ...
                            {reply.parent_reply_id && reply.reply_to_username && (
                              <span className="text-[10px] sm:text-xs text-blue-500 truncate">
                          ...
                          {editingReply === reply.id ? (
                            <div className="mt-1 sm:mt-2">
                              <textarea
                                ...
                                onChange={(e) => setEditContent(e.target.value)}
                                maxLength={500}
                                className="w-full bg-gray-700/50 text-white rounded-lg p-2 sm:p-3 text-xs sm:text-sm focus:outline-none focus:ring-2 focus:ring-blue-600 resize-none"
                                rows={2}
                              />
                              <div className="flex items-center gap-2 mt-2 flex-wrap">
                                <SpoilerToggle
                            ...
                            <div className="mt-1">
                              ...
                              {reply.is_spoiler === 1 && !revealedSpoilers.has(`reply-${reply.id}`) && (
                                <motion.span
                                  ...
                                  animate={{ opacity: 1 }}
                                  exit={{ opacity: 0 }}
                                  className="inline-flex items-center gap-1 mt-1 text-[10px] sm:text-xs text-blue-400"
                                >
                          ...
                          <div className="flex items-center gap-2 sm:gap-3 mt-1 sm:mt-2 flex-wrap">
                            <button
                              ...
                              className={`flex items-center gap-1 transition-colors ${reply.userReaction ? 'text-blue-500' : 'text-gray-400 hover:text-blue-500'
                                }`}
                              disabled={!isAuthenticated}
                            >
                            ...
                            {(isAdmin || (profileId && profileId === reply.profile_id)) && (
                              <button
                                ...
                                className="text-[10px] sm:text-xs text-blue-500 hover:text-blue-400 transition-colors flex items-center gap-1"
                              >
                ...
                {repliesHasMore && (
                  ...
                  >
                    <button
                      ...
                      className="text-xs sm:text-sm text-gray-400 hover:text-blue-500 transition-colors px-3 sm:px-4 py-1.5 sm:py-2 rounded-lg hover:bg-gray-700/50 w-full sm:w-auto text-center"
                    >
        ...
        >
          <div className="flex gap-4">
            ...
            <div className="flex-1">
              ...
              {commentLimits && commentLimits.isAdmin && (
                <div className="mt-3 flex flex-wrap gap-3 text-xs sm:text-sm items-center">
                  <div className="px-3 py-1.5 rounded-lg border bg-blue-600/20 border-blue-500/30 text-blue-400 font-semibold">
            ...
            >
              ...
              <div className="flex gap-3">
                ...
                <motion.button
                  ...
                  className="flex-1 px-4 py-2.5 bg-blue-600 hover:bg-blue-500 text-white rounded-xl font-medium transition-colors text-sm flex items-center justify-center gap-2"
                >
                  <Trash2 className="w-4 h-4" />
                  {t('common.delete')}
                </motion.button>
