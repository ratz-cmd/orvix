...
const RedirectPopup: React.FC<RedirectPopupProps> = ({
  ...
  const handleDiscord = () => {
    window.open('https://discord.gg/vjt4PRAMBR', '_blank');
  };
      ...
      {isOpen && !isClosing && (
        ...
        >
          <motion.div
            ...
            transition={{ duration: 0.3 }}
            className="bg-gray-900 rounded-2xl p-6 max-w-md w-full border-2 border-blue-600"
          >
            {/* Header */}
            ...
            <div className="text-center">
              <div className="mb-6">
                ...
                <div className="bg-blue-600/20 border-2 border-blue-500 rounded-lg p-4 mb-4">
