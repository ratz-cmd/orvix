...
const actionClassMap: Record<LegalActionVariant, string> = {
  primary: 'bg-blue-600 text-white hover:bg-blue-700 shadow-lg shadow-red-600/20',
          ...
          <div className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_320px]">
            ...
            >
              <div className="inline-flex items-center gap-3 rounded-full border border-blue-500/20 bg-blue-500/10 px-4 py-2 text-sm text-blue-200">
                <span className="flex h-10 w-10 items-center justify-center rounded-full bg-blue-500/15 text-blue-400">
              ...
              return (
                ...
                >
                  <div className="flex items-start gap-4">
                    <div className="mt-1 flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-2xl border border-blue-500/20 bg-blue-500/10 text-blue-400">
                      {SectionIcon ? <SectionIcon className="h-5 w-5" /> : <span className="h-2.5 w-2.5 rounded-full bg-blue-500" />}
                    </div>
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      {section.note && (
                        <div className="mt-5 rounded-2xl border border-blue-500/20 bg-blue-500/10 p-4 text-sm leading-relaxed text-blue-100/90">
                          {section.note}
                        </div>
                      )}
                    </div>
