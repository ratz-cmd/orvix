    ...
    <div className="relative z-50 flex items-center justify-center">
      ...
      >
        {isAuthenticated ? (
          <div className="flex items-center gap-1 sm:gap-2">
            <div className="relative group">
              <img
                ...
                className="w-7 h-7 md:w-7 md:h-7 max-md:w-7 max-md:h-7 rounded-full object-cover border-2 border-transparent group-hover:border-blue-600 transition-all duration-300 shadow-md"
                onError={(e) => {
          ...
          <div className="flex items-center gap-1.5 sm:gap-2 px-3 sm:px-3.5 py-1.5 rounded-full bg-gradient-to-r from-blue-600 to-blue-600 hover:from-blue-500 hover:to-blue-500 text-white shadow-md shadow-red-600/25 border border-blue-500/40 transition-all duration-200">
                ...
                <>
                  <div className="px-5 py-4 border-b border-gray-700/50">
                    <div className="flex items-center gap-3">
                      <img 
                        src={profileImage} 
                        alt={t('header.profile')}
                        className="w-10 h-10 md:w-10 md:h-10 max-md:w-12 max-md:h-12 rounded-full object-cover border-2 border-blue-600/70"
                        onError={(e) => {
                          e.currentTarget.src = 'https://as2.ftcdn.net/v2/jpg/05/89/93/27/1000_F_589932782_vQAEAZhHnq1QCGu5ikwrYaQD0Mmurm0N.webp';
                        }}
                      />
                  ...
                  <div className="px-4 py-3 border-t border-gray-700/50 space-y-3">
                    {canAccessAdminPanel && (
                      <Link
                        to="/admin"
                        className="flex items-center justify-center gap-2 w-full px-3 py-3 max-md:py-4 bg-gradient-to-r from-amber-500/90 to-blue-600/90 hover:from-amber-500 hover:to-blue-600 text-white rounded-lg transition-colors shadow-md"
                        onClick={() => setIsOpen(false)}
                      >
                    ...
                    <motion.div 
                      ...
                      whileTap={{ scale: 0.98 }}
                      className="flex items-center justify-center gap-2 w-full px-3 py-3 max-md:py-4 bg-blue-600/80 hover:bg-blue-600 text-white rounded-lg transition-colors cursor-pointer"
