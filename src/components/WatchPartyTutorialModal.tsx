                    ...
                    >
                        ...
                        <div className="p-4 md:p-6 md:pb-8 flex-1 overflow-y-auto custom-scrollbar overscroll-contain">
                            <div className="relative border border-white/10 rounded-lg overflow-hidden bg-black/50 group shrink-0">
                                                ...
                                                <div className="aspect-video flex items-center justify-center p-1 bg-black/40">
                                                    {slide.image ? (
                                                        ...
                                                        <div className="px-12 py-4 md:px-16 md:py-8 text-center select-none flex flex-col items-center justify-center h-full">
                                                            <Users className="h-10 w-10 md:h-16 md:w-16 text-blue-500 mb-4" />
                                ...
                                <button
                                    onClick={scrollPrev}
                                    className="absolute left-2 md:left-4 top-1/2 -translate-y-1/2 p-2 md:p-3 bg-black/50 hover:bg-blue-600 rounded-full text-white transition-all backdrop-blur-sm z-10"
                                >
                                    <ChevronLeft size={20} className="md:w-6 md:h-6" />
                                </button>
                                <button
                                    onClick={scrollNext}
                                    className="absolute right-2 md:right-4 top-1/2 -translate-y-1/2 p-2 md:p-3 bg-black/50 hover:bg-blue-600 rounded-full text-white transition-all backdrop-blur-sm z-10"
                                >
                            ...
                            <div className="flex justify-center gap-2 md:gap-3 mt-4 mb-2">
                                {tutorialSlides.map((_, index) => (
                                    <button
                                        ...
                                        className={`h-1.5 md:h-2 rounded-full transition-all duration-300 ${index === currentSlide ? 'bg-blue-500 w-6 md:w-8' : 'bg-white/20 w-1.5 md:w-2 hover:bg-white/40'
                                            }`}
                                    />
                                ))}
                            </div>
