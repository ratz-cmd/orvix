...
const statusOptions = [
    ...
    { value: 'rejected', label: 'admin.statusRejected', color: 'text-blue-400' },
];
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <div className="flex items-center gap-2">
                                                ...
                                                <Badge variant={entry.role === 'admin' ? 'default' : 'secondary'} className={`text-xs ${
                                                    entry.role === 'admin' ? 'bg-blue-500/20 text-blue-400' : 'bg-blue-500/20 text-blue-400'
                                                }`}>
                                ...
                                >
                                    <div className="flex items-center gap-3">
                                        {result.available ? (
                                            ...
                                            <XCircle className="h-5 w-5 text-blue-400 opacity-50" />
                                        )}
                                        ...
                                        >
                                            <div className="flex items-center gap-2">
                                                {result.available ? (
                                                    ...
                                                    <XCircle className="h-4 w-4 text-blue-400 opacity-50" />
                                                )}
                                ...
                                {batchResults.filter(r => r.availableCategories === 0).length > 0 && (
                                    <div className="space-y-2">
                                        ...
                                        {batchResults.filter(r => r.availableCategories === 0).map((item) => (
                                            <div key={item.request.id} className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-2 flex items-center gap-2">
