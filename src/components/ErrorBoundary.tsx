...
const DISCORD_WEBHOOK_URL = import.meta.env.VITE_ERROR_DISCORD_WEBHOOK_URL || '';
...
class ErrorBoundary extends React.Component<React.PropsWithChildren, ErrorBoundaryState> {
  ...
  handleSendReport = async () => {
    ...
    const embeds = [
      {
        title: ':rotating_light: Crash Report — Orvix',
        color: 0xdc2626,
        fields: [
  ...
  render() {
    ...
    if (this.state.recoverable) {
      ...
      const title = isChunk ? 'Mise à jour de Orvix' : 'Rechargement';
      ...
      return (
        <div style={{ minHeight: '100vh', backgroundColor: '#000', color: '#f3f4f6', fontFamily: 'ui-sans-serif, system-ui, sans-serif', padding: 24, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          <div style={{ maxWidth: 420, width: '100%', textAlign: 'center' }}>
            <div style={{ fontSize: 32, fontWeight: 900, color: '#2563eb', letterSpacing: '0.1em', marginBottom: 24 }}>ORVIX</div>
            {reloadScheduled && (
              <div style={{ width: 40, height: 40, margin: '0 auto 24px', border: '3px solid rgba(255,255,255,0.1)', borderTopColor: '#2563eb', borderRadius: '50%', animation: 'orvix-eb-spin 0.8s linear infinite' }} />
            )}
            ...
            <div style={{ display: 'flex', gap: 12, justifyContent: 'center', marginTop: 24 }}>
              <button onClick={this.handleReload} style={{ padding: '10px 20px', borderRadius: 8, border: 'none', fontWeight: 600, fontSize: 14, cursor: 'pointer', backgroundColor: '#2563eb', color: '#fff' }}>Recharger</button>
          ...
          <style>{`@keyframes orvix-eb-spin { to { transform: rotate(360deg); } }`}</style>
        </div>
      );
    }
      ...
      <div style={{ minHeight: '100vh', backgroundColor: '#000', color: '#f3f4f6', fontFamily: 'ui-sans-serif, system-ui, sans-serif', padding: '24px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{ maxWidth: 700, width: '100%' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 24 }}>
            ...
            <div>
              <h1 style={{ margin: 0, fontSize: 24, fontWeight: 700, color: '#fff' }}>Orvix a rencontré une erreur</h1>
          ...
          {/* Error message */}
          <div style={{ backgroundColor: '#1c1c1c', border: '1px solid #2563eb', borderRadius: 8, padding: 16, marginBottom: 16 }}>
            <p style={{ margin: 0, fontSize: 13, color: '#2563eb', fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.05em' }}>Erreur</p>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 12 }}>
            <button
              ...
              style={{
                ...
                backgroundColor: sent ? '#16a34a' : sendError ? '#2563eb' : '#2563eb',
                color: '#fff',
