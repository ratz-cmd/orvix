                    ...
                    >
                        ...
                        <div className="p-6 border-b border-white/10 flex justify-between items-center">
                            <h3 className="text-xl font-bold text-white flex items-center gap-2">
                                <Key className="text-blue-500 h-5 w-5" />
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    <Input
                                        ...
                                        className="bg-black/50 border-white/10 text-white placeholder:text-white/30 text-center text-2xl tracking-[0.15em] font-mono h-16 uppercase focus-visible:ring-blue-500"
                                        maxLength={8}
                                        autoFocus
                                    />
                                    <div className="absolute inset-x-0 bottom-0 h-0.5 bg-gradient-to-r from-transparent via-blue-500/50 to-transparent" />
                                </div>
