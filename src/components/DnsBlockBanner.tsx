...
const TOAST_ID = 'orvix-dns-block';
...
const DnsBlockBanner: React.FC = () => {
  ...
  useEffect(() => {
      ...
      toast.custom(
        (id) => (
          <div
            ...
            className="w-[min(92vw,420px)] flex gap-3 p-4 rounded-xl border border-blue-500/50 bg-blue-950/95 backdrop-blur-md shadow-2xl text-blue-50 select-none"
          >
            <ShieldAlert
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-start justify-between gap-2 mb-1">
                ...
                <button
                  ...
                  className="shrink-0 -mr-1 -mt-1 p-1 rounded text-blue-200/70 hover:text-blue-50 hover:bg-blue-900/50 transition-colors"
                >
                  <X className="w-4 h-4" />
                </button>
              </div>
              ...
              {wasSwitched && (
                <p className="text-xs text-blue-200/90 italic leading-relaxed mb-3">
              ...
              <div className="flex flex-col sm:flex-row gap-2 mt-1">
                <button
                  ...
                  className="flex-1 px-3 py-2 rounded-md bg-blue-500 hover:bg-blue-400 text-white font-semibold text-xs transition-colors"
                >
    ...
    window.addEventListener('orvix:dns-blocked', onBlocked);
    window.addEventListener('orvix:dns-blocked', onBlocked);
    return () => {
      window.removeEventListener('orvix:dns-blocked', onBlocked);
      window.removeEventListener('orvix:dns-blocked', onBlocked);
    };
  }, [t, navigate]);
