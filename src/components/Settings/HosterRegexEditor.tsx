      ...
      <div className="space-y-1 pt-1">
        <div className="flex items-center gap-2">
          <Input
            ...
            className={localError ? 'border-blue-500' : ''}
          />
        ...
        {localError && <p className="text-xs text-blue-400">{localError}</p>}
      </div>
    );
  }
                        ...
                        <div className="space-y-1 pt-1">
                          <div className="flex items-center gap-2">
                            <Input
                              ...
                              className={newPatternError ? 'border-blue-500' : ''}
                            />
                            <Button
                              size="sm"
                          ...
                          {newPatternError && (
                            <p className="text-xs text-blue-400">{regexErrorMessage(newPatternError)}</p>
                          )}
                        </div>
                      ) : (
                        <Button
      ...
      >
        <div className="flex flex-col gap-3">
          ...
          <Input
            ...
            className={customError && customError.kind !== 'nameRequired' ? 'border-blue-500' : ''}
          />
          {customError && <p className="text-xs text-blue-400">{customErrorMessage(customError)}</p>}
