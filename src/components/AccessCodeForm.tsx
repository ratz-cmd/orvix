  ...
  if (isModal) {
    return (
      <div className="w-full">
        <h2 className="text-2xl font-bold text-white mb-6 text-center bg-gradient-to-r from-blue-500 to-purple-500 bg-clip-text text-transparent">
          {t('vip.accessOrvixVip')}
        </h2>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {error && (
            <motion.p 
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              className="text-blue-500 text-sm mt-2 bg-blue-500/10 p-3 rounded-lg border border-blue-500/20"
            >
              {error}
            </motion.p>
          )}
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-gray-900 to-black">
      <div className="relative w-full max-w-md mx-4">
        ...
        >
          <h2 className="text-3xl font-bold text-white mb-8 text-center bg-gradient-to-r from-blue-500 to-purple-500 bg-clip-text text-transparent">
            {t('vip.accessOrvixVip')}
          </h2>
