    ...
    return (
        ...
        >
            ...
            <div className="absolute left-0 right-0 h-2 bg-gray-700 rounded-full overflow-hidden">
                ...
                <div
                    className={`h-full bg-blue-600 ${isDragging ? '' : 'transition-all duration-150 ease-out'}`}
            ...
            <div
                className={`absolute top-1/2 -translate-y-1/2 w-5 h-5 bg-white rounded-full shadow-lg ${isDragging ? '' : 'transition-all duration-100 ease-out'} hover:scale-110 active:scale-125 focus:outline-none focus:ring-2 focus:ring-blue-500`}
                style={{
                    left: `${percentage}%`,
