            ...
            <ol className="space-y-3">
              {s.stepKeys.map((key, idx) => (
                <li key={idx} className="flex gap-3">
                  <span className="shrink-0 w-7 h-7 rounded-full bg-blue-500/20 border border-blue-500/40 text-blue-300 text-sm font-semibold flex items-center justify-center">
                    {idx + 1}
                  </span>
              ...
              {s.causes.map((c, idx) => (
                ...
                >
                  <div className="flex items-center gap-3 mb-2">
                    <span className="shrink-0 w-8 h-8 rounded-full bg-blue-500/20 border border-blue-500/40 text-blue-300 text-sm font-semibold flex items-center justify-center">
                      {idx + 1}
                    </span>
                    <span className="shrink-0 text-blue-400 flex items-center justify-center">
                      {c.icon}
                    </span>
    ...
    <SquareBackground className="min-h-screen">
      ...
      >
        ...
        >
          <Link
            to={backHref}
            className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-blue-500 hover:bg-blue-400 text-white font-semibold text-sm transition-colors"
          >
            <ArrowLeft className="w-4 h-4" />
            {t(backLabelKey)}
          </Link>
