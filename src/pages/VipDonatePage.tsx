...
const PACKS = [
  ...
  { amount: 20, years: 4, accent: 'from-blue-500/15 to-transparent' }
] as const;
...
const SUPPORT_TELEGRAM_URL = import.meta.env.VITE_SUPPORT_TELEGRAM_URL || 'https://discord.gg/vjt4PRAMBR';
