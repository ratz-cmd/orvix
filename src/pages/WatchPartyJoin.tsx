            ...
            {roomInfo && (
              ...
              >
                <div className="flex items-start gap-4">
                  <div className="p-3 bg-blue-500/10 rounded-lg shrink-0 text-blue-400">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                <label htmlFor="roomCode" className="block text-sm font-medium mb-2 text-white/80 flex items-center gap-2">
                  <Hash className="h-4 w-4 text-blue-500" /> {t('watchParty.watchPartyCode')}
                </label>
                <input
                  type="text"
                  id="roomCode"
                  ...
                  className="w-full px-4 py-4 bg-white/5 border border-white/10 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 tracking-[0.5em] uppercase font-mono text-center text-xl text-white placeholder-white/20 transition-all"
                  autoComplete="off"
                />
              </div>
              ...
              <div>
                <label htmlFor="nickname" className="block text-sm font-medium mb-2 text-white/80 flex items-center gap-2">
                  <User className="h-4 w-4 text-blue-500" /> {t('watchParty.yourPseudo')}
                </label>
                <input
                  type="text"
                  id="nickname"
                  ...
                  className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-white placeholder-white/30 transition-all"
                  maxLength={32}
                />
              </div>
              ...
              <Button
                ...
                className={`
                  ...
                  ${isJoining || !roomCode || !nickname ? 'bg-white/10 text-white/50 cursor-not-allowed' : 'bg-blue-600 hover:bg-blue-700 text-white border-0'}
                `}
              >
                {isJoining ? (
