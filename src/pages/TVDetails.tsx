...
import OrvixRatingInfoModal from '../components/OrvixRatingInfoModal';
                  ...
                  {(['backdrops', 'posters', 'logos'] as const).map((category) => {
                    ...
                    return (
                      <button
                        ...
                        className={`relative flex-1 min-w-0 flex items-center justify-center gap-2 px-3 sm:px-4 py-2 rounded-lg text-sm font-medium whitespace-nowrap transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500/60 ${
                      ...
                      >
                        {isActive && (
                          <motion.div
                            ...
                            className="absolute inset-0 bg-blue-600 rounded-lg shadow-sm shadow-red-600/30"
...
const TVDetails: React.FC = () => {
  ...
  // Track page visit for Orvix Wrapped
  useWrappedTracker({
    mode: 'page',
  ...
  const [orvixVoteStats, setOrvixVoteStats] = useState<LikeDislikeStats>({ likes: 0, dislikes: 0 });
  const [showOrvixRatingInfo, setShowOrvixRatingInfo] = useState(false);
  ...
  useEffect(() => {
    setOrvixVoteStats({ likes: 0, dislikes: 0 });
  }, [id]);

  const orvixRating = calculateLikeDislikeRating(orvixVoteStats);
      ...
      <div className="flex flex-col gap-4 mt-4">
        ...
        <div className="flex flex-wrap gap-3 w-full min-w-0">
          <motion.button
            ...
            className="flex flex-col items-center gap-2 px-4 sm:px-6 py-4 sm:py-5 bg-blue-600 hover:bg-blue-700 rounded-lg flex-1 min-w-0 justify-center text-xs sm:text-sm"
          >
            ...
            <div className="text-center">
              {continueWatchingData.hasProgress ? (
                <div className="flex flex-col items-center text-center w-full">
                  ...
                  <span className="text-xs bg-blue-800/80 text-white px-1.5 py-0.5 rounded font-medium mt-1">
  ...
  useEffect(() => {
    if (tvShow) {
      ...
      document.title = `${tvShow.name} — Orvix | Streaming Séries VF & VOSTFR`;
    } else {
  ...
  if (error) return <div className="text-center text-blue-500">{error}</div>;
                ...
                if (isAnime) {
                  ...
                  return (
                    <motion.div
                      ...
                      className={`group relative rounded-xl overflow-hidden border border-white/10 hover:border-blue-500 transition-all duration-300 bg-gray-800 flex flex-col ${isSelected ? 'ring-2 ring-blue-500' : ''}`}
                    ...
                    >
                      ...
                      >
                        <div className="flex flex-col">
                          <h4 className="text-lg font-medium group-hover:text-blue-500 transition-colors mb-2">
                            {ep.index}. {ep.name}
                          </h4>
                  ...
                  return (
                    <motion.div
                      ...
                      className={`group relative rounded-xl overflow-hidden border border-white/10 hover:border-blue-500 transition-all duration-300 bg-white/10 flex flex-col ${isSelected ? 'ring-2 ring-blue-500' : ''}`}
                      whileHover={{ y: -5, transition: { duration: 0.2 } }}
                      layout={false}
                    >
                      <div
                        ...
                        <div className="flex flex-col">
                          <div className="relative aspect-video w-full">
                            ...
                            <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-black/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity">
                              <div className="absolute inset-0 flex items-center justify-center">
                                <div className="bg-blue-600/90 rounded-full p-3 transform scale-0 group-hover:scale-100 transition-transform duration-300">
                            ...
                            {displayProgress > 0 && (
                              <div className="absolute bottom-0 left-0 right-0 h-1 bg-gray-700">
                                <div
                                  className={`h-full ${displayProgress >= 95 ? 'bg-green-500' : 'bg-blue-600'} transition-all`}
                          ...
                          <div className="p-4">
                            <div className="flex items-start justify-between gap-4">
                              <div>
                                <h4 className="text-lg font-medium group-hover:text-blue-500 transition-colors">
                                ...
                                <div className="flex items-center gap-3 mt-1 text-sm text-white/60">
                                  <div className="flex items-center gap-1.5">
                                    <Calendar className="h-3.5 w-3.5 text-blue-400 opacity-70" />
                                  ...
                                  {ep.runtime && (
                                    <div className="flex items-center gap-1.5">
                                      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-clock h-3.5 w-3.5 text-blue-400 opacity-70"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline></svg>
                            ...
                            <div className="flex gap-2 mt-3 justify-end">
                              <button
                                ...
                                className={`p-2 rounded ${watchStatus?.episodeWatchlist?.[episodeKey] ? 'text-blue-600' : 'text-gray-400'} hover:bg-gray-800`}
                              ...
                              <button
                                ...
                                className={`p-2 rounded ${watchStatus?.episodeWatched?.[episodeKey] ? 'text-blue-600' : 'text-gray-400'} hover:bg-gray-800`}
  ...
  const tvYear = tvShow.first_air_date && !isNaN(new Date(tvShow.first_air_date).getTime())
    ...
    : null;
  const tvTitle = tvYear ? `${tvShow.name} (${tvYear}) — Orvix | Streaming Séries VF & VOSTFR` : `${tvShow.name} — Orvix | Streaming Séries VF & VOSTFR`;
  ...
  const tvSocialImage = tvShow.backdrop_path || tvShow.poster_path
    ...
    : undefined;
  const tvDescription = tvShow.overview?.trim() || `Regardez la série ${tvShow.name} en streaming HD 1080p VF et VOSTFR sur Orvix.`;
  ...
  return (
    <MotionConfig reducedMotion="user">
                ...
                >
                  ...
                  >
                    <div className="mb-4">
                      <LikeDislikeButton
                        contentType="tv"
                        contentId={id || ''}
                        onStatsChange={setOrvixVoteStats}
                      />
                    </div>

                    {/* TMDB Info Box */}
                    <div className="mb-6 p-4 border border-blue-500/50 bg-blue-500/10 rounded-lg flex gap-3 items-start">
                  ...
                  >
                      ...
                      {orvixRating != null && (
                        <div>
                          <h3 className="mb-2 flex items-center gap-2 text-lg font-semibold">
                            {t('details.orvixRatingLabel')}
                            <button
                              type="button"
                              onClick={() => setShowOrvixRatingInfo(true)}
                              aria-label={t('details.orvixRatingInfoButtonLabel')}
                              title={t('details.orvixRatingInfoButtonLabel')}
                              className="rounded-full text-gray-400 transition-colors hover:text-white focus:outline-none focus:ring-2 focus:ring-blue-500/70"
                            >
                              <Info className="h-4 w-4" />
                            </button>
                          </h3>
                          <div className="flex items-center gap-2">
                            <Star className="w-5 h-5 text-blue-500 fill-red-500" />
                            <p className="text-gray-300 text-lg font-bold">{orvixRating.toFixed(1)}<span className="text-sm font-normal text-gray-400">/10</span></p>
                          </div>
                        </div>
                      )}
                    </div>
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2">
                        {certifications['FR'] ? (
                          <span className="bg-blue-600/70 text-white px-3 py-1 rounded-md font-bold">
                          ...
                          animeData.seasons.map((season: any, index: number) => {
                            ...
                            return (
                              <motion.div
                                ...
                                className={`group cursor-pointer rounded-lg overflow-hidden border-2 transition-all duration-200 bg-gray-900 ${selectedSeason === seasonNumber ? 'border-blue-600' : 'border-gray-800 hover:border-blue-500'}`}
                          ...
                          <div className="flex items-center gap-2 mt-1">
                            <span className="text-xs text-gray-400 ml-auto">{season.episodes.length} épisodes</span>
                                  ...
                                  {selectedSeason === seasonNumber && (
                                    <div className="absolute top-2 right-2 bg-blue-600 text-white text-xs px-2 py-1 rounded-full">{t('details.currentSeasonBadge')}</div>
                                  )}
                                </div>
                          ...
                          [...(tvShow.seasons ?? [])]
                            ...
                            return (
                              <motion.div
                                ...
                                exit={{ opacity: 0, scale: 0.9 }}
                                transition={{ duration: 0.3 }}
                                className={`group cursor-pointer rounded-lg overflow-hidden border-2 transition-all duration-200 ${selectedSeason === season ? 'border-blue-600' : 'border-gray-800 hover:border-blue-500'}`}
                            ...
                            <>
                              ...
                              >
                                ...
                                <div className="grid grid-cols-2 gap-2">
                                  ...
                                  <div className="bg-gray-900 p-2 rounded-lg">
                                    <h5 className="text-xs font-medium text-blue-400 mb-1">{t('details.negativeFactors')}</h5>
                                    <ul className="list-disc pl-4 text-xs text-gray-300 space-y-0.5">
                                      {!tvShow.in_production &&
                          ...
                          <div className="mt-3 space-y-3">
                            <div className="relative pt-1">
                              ...
                              <div className="overflow-hidden h-2 mt-1 text-xs flex rounded bg-gray-700">
                                <div style={{ width: "55%" }} className="shadow-none flex flex-col text-center whitespace-nowrap text-white justify-center bg-blue-500"></div>
                              </div>
                            </div>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                              {filteredVideos.map((video: any, index: number) => (
                                <motion.div
                                  ...
                                  className="group bg-gray-800/70 rounded-xl overflow-hidden border border-gray-700/50 hover:border-blue-500/30"
                                  initial={{ opacity: 0, y: 20, scale: 0.9 }}
                                  animate={{ opacity: 1, y: 0, scale: 1 }}
                                  transition={{
                                    delay: index * 0.1,
                                ...
                                >
                                  ...
                                  >
                                    ...
                                    >
                                      <motion.div
                                        className="w-14 h-14 rounded-full bg-blue-600/90 flex items-center justify-center shadow-lg"
                                        whileHover={{
                                          scale: 1.1,
                                  ...
                                  >
                                    <h4 className="font-semibold mb-2 line-clamp-1 text-white group-hover:text-blue-400 transition-colors">{video.name}</h4>
                                    <div className="flex items-center text-sm text-gray-400">
                                      <motion.span
                              ...
                              {seasonVideos[seasonNum].map((video: any, index: number) => (
                                ...
                                >
                                  ...
                                  >
                                    ...
                                    <div className="flex items-center text-sm text-gray-400">
                                      <motion.span
                                        className={`text-xs px-2 py-1 rounded-md mr-2 font-medium ${video.type === 'Trailer' ? 'bg-blue-600/70 text-white' :
      ...
      >
        ...
        >
          {loadingSimilar ? (
            ...
            <EmblaCarousel
              title={<span><span className="text-blue-600 mr-2"></span>{t('details.similarSeries')}</span>}
      ...
      <OrvixRatingInfoModal
        isOpen={showOrvixRatingInfo}
        onClose={() => setShowOrvixRatingInfo(false)}
      />
