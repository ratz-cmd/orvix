...
const androidSteps = [
  {
    ...
    desc: 'Cliquez sur le bouton de téléchargement ci-dessous pour récupérer orvix-android.apk.',
  },
  {
    step: 2,
  ...
  {
    step: 4,
    title: 'Profitez de Orvix',
    desc: 'L\'icône Orvix apparaît sur votre écran d\'accueil, prête à être utilisée.',
  },
];
      ...
      <div className="container mx-auto px-4 sm:px-6 py-8 sm:py-12 relative z-10 h-full overflow-y-auto">
        ...
        <div className="max-w-4xl mx-auto text-center mb-16">
          ...
          >
            ...
            <BlurText
              text="Téléchargez l'application Orvix et profitez de tous vos contenus préférés directement depuis votre smartphone."
              delay={150}
          ...
          <motion.div variants={itemVariants}>
            ...
            >
              ...
              <p className="text-white/55 text-sm leading-relaxed mb-6">
                Installez Orvix sur votre appareil Android en téléchargeant directement
            ...
            <div className="flex flex-col md:flex-row items-center gap-6 md:gap-8">
              ...
              <div className="flex-1 text-center md:text-left">
                <h3 className="text-xl sm:text-2xl font-bold text-white mb-2">
                  L'extension Orvix est intégrée dans l'application
                </h3>
              ...
              <div className="flex flex-row md:flex-col gap-3 w-full md:w-auto md:min-w-[180px]">
                ...
                <div className="flex-1 md:flex-none flex items-center gap-3 p-3 rounded-xl bg-blue-500/10 border border-blue-500/20">
                  ...
                  <div>
                    ...
                    <p className="text-[11px] text-blue-400/80 leading-tight">navigation allégée</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        >
          <div className="text-center mb-6">
            ...
            <p className="text-white/50 max-w-2xl mx-auto">
              ...
              fonctionnalités de Orvix à portée de main.
            </p>
          </div>
        ...
        >
          <div className="text-center mb-6">
            ...
            <p className="text-white/50 max-w-xl mx-auto">
              Suivez ces quelques étapes simples pour installer Orvix sur votre appareil.
            </p>
          </div>
        ...
        >
          ...
          >
            ...
            <h3 className="text-xl font-bold text-white mb-2">Prêt à installer Orvix ?</h3>
