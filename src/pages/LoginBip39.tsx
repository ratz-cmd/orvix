        ...
        <div className="bg-gray-900/50 border border-gray-800 rounded-2xl p-6 backdrop-blur-sm">
            ...
            <div>
              ...
              <div className="relative">
                <textarea
                  ...
                  className="w-full bg-gray-800/70 text-white px-4 py-3 pr-12 rounded-xl border border-gray-700 focus:ring-2 focus:ring-blue-500 outline-none transition-all duration-300 resize-none"
          ...
          <div className="space-y-4">
            ...
            <motion.button
              ...
              className="w-full bg-gradient-to-r from-blue-600 to-blue-700 text-white py-3 rounded-xl font-medium hover:from-blue-700 hover:to-blue-800 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
              {isLoading ? (
                <>
