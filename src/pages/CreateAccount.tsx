    ...
    >
      ...
      {isGenerating ? (
        ...
        <motion.button
          ...
          className="w-full bg-gradient-to-r from-blue-600 to-blue-700 text-white py-3 rounded-xl font-medium hover:from-blue-700 hover:to-blue-800 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
        >
    ...
    >
      ...
      <div className="text-center">
        ...
        <div className="relative inline-block">
          <motion.div
            ...
            className="w-24 h-24 rounded-full overflow-hidden border-2 border-blue-600/70 cursor-pointer"
      ...
      <div>
        ...
        <input
          ...
          className="w-full bg-gray-800/70 text-white px-4 py-3 rounded-xl border border-gray-700 focus:ring-2 focus:ring-blue-500 outline-none transition-all duration-300"
    ...
    >
      ...
      <div>
        ...
        <textarea
          ...
          className="w-full bg-gray-800/70 text-white px-4 py-3 rounded-xl border border-gray-700 focus:ring-2 focus:ring-blue-500 outline-none transition-all duration-300 resize-none"
