  ...
  <div className="min-h-screen bg-black flex flex-col items-center justify-center text-white p-4">
    <div className="bg-white/5 border border-white/10 p-8 rounded-xl shadow-lg max-w-md w-full text-center backdrop-blur-sm">
      ...
      {onRetry && (
        <button
          onClick={onRetry}
          className="px-6 py-3 bg-blue-600 hover:bg-blue-700 rounded-lg font-medium mr-2"
        >
...
const CHAT_MD_COMPONENTS: Components = {
  ...
  code: ({ children, className }) => {
    ...
    return isBlock ? (
      ...
      <code className="bg-white/10 text-blue-300 px-1 py-0.5 rounded text-[0.85em] font-mono">{children}</code>
    );
  },
      ...
      >
        <div
          className={`px-3 py-2 rounded-xl max-w-[85%] relative group ${message.type === 'system'
            ...
            : isOwnMessage
              ? 'bg-blue-600/80 text-white shadow-lg shadow-red-500/10'
            ...
            <div className="absolute -right-1 -top-1 opacity-0 group-hover:opacity-100 transition-opacity flex gap-0.5">
              ...
              {isCurrentUserHost && (
                <button
                  ...
                  className="p-1 bg-gray-800 rounded-full text-blue-400 hover:text-blue-300 hover:bg-gray-700"
    ...
    <div className="flex flex-col h-[100dvh] bg-black text-white overflow-hidden">
        ...
        <div className="flex items-center gap-1.5 md:gap-2 flex-shrink-0">
          ...
          <button onClick={() => setShowParticipantsPanel(true)} className="p-1.5 bg-white/10 hover:bg-white/20 rounded-md relative">
            ...
            {participants.length > 0 && (
              <span className="absolute -top-1.5 -right-1.5 bg-blue-600 text-xs h-5 w-5 flex items-center justify-center rounded-full border-2 border-black">
                {participants.length}
              </span>
            )}
          </button>
          ...
          <button onClick={leaveRoom} className="p-1.5 bg-blue-600 hover:bg-blue-700 rounded-md" title={t('watchParty.quitLabel')}>
            <X size={18} />
          </button>
        </div>
      </div>
              ...
              {pauseCountdown > 0 && (
                <div className="absolute inset-0 flex items-center justify-center bg-black/80 z-[9990]" style={{ pointerEvents: 'auto' }}>
                  ...
                  >
                    ...
                    <p className="text-xl text-gray-300 mb-4">⏸ {t('watchParty.pauseInProgress')}</p>
                    {canControlPlayback && (
                      <button
        ...
        <AnimatePresence>
          {showChatPanel && participants.length > 0 && (
            ...
            >
              ...
              <div
                className="hidden md:block absolute left-0 top-0 bottom-0 w-1.5 cursor-col-resize hover:bg-blue-500/30 active:bg-blue-500/50 transition-colors z-20"
                onMouseDown={(e) => {
                  e.preventDefault();
                  ...
                  >
                    <div className="p-3 bg-white/5 border-b border-white/10">
                      <div className="flex items-center justify-between mb-2">
                        <span className="text-xs font-semibold text-purple-300 uppercase tracking-wide">🗳 {t('watchParty.voteLabel')}</span>
                        <span className="text-xs text-orange-400 font-bold">⏱ {voteCountdown}s</span>
                      </div>
                      ...
                      <div className="flex justify-between text-xs text-gray-400 mb-3">
                        ...
                        <span className="text-blue-400">✗ {voteProgress.noVotes}</span>
                      </div>
                      ...
                      {!hasVoted ? (
                        <div className="flex gap-2">
                          ...
                          <button
                            ...
                            className="flex-1 py-2 bg-blue-600 hover:bg-blue-700 rounded-lg font-semibold text-sm transition-colors"
                          >
                            ✗ {t('watchParty.voteNo')}
                          </button>
                        </div>
              ...
              <div className="p-3 border-t border-white/10 bg-black/60 shrink-0">
                ...
                <form onSubmit={sendChatMessageWithReactions} className="flex items-end gap-2">
                  <textarea
                    ...
                    rows={2}
                    className="flex-1 bg-white/5 border border-white/10 rounded-xl px-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-blue-500 placeholder-white/30 text-white disabled:opacity-50 resize-y min-h-[42px] max-h-32 overflow-y-auto"
                  />
                  <button
                    type="submit"
                      ...
                      <div className="flex items-center gap-1.5">
                        ...
                        {participant.id === roomInfo.hostId ? (
                          ...
                          <button
                            ...
                            className="p-1.5 text-gray-400 hover:text-blue-400 hover:bg-gray-700/60 rounded-full transition-colors"
      ...
      {!showChatPanel && (
        <motion.button
          ...
          className="fixed bottom-6 right-6 z-[45] p-4 bg-blue-600 hover:bg-blue-700 rounded-full shadow-lg transition-colors"
      ...
      {roomInfo && !showChatPanel && (
        <div className="hidden bg-gray-800/90 backdrop-blur-sm border-t border-gray-700/60 py-2 px-4 shadow-top shrink-0">
          <button onClick={handleCopyInviteLink} className="w-full flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 py-2 rounded-lg font-medium text-sm transition-colors">
            <Share2 size={18} />
                ...
                <div key={request.participantId} className="flex items-center justify-between bg-gray-700/50 p-2 rounded-lg">
                  ...
                  <div className="flex gap-1">
                    ...
                    <button
                      ...
                      className="p-1.5 bg-blue-600 hover:bg-blue-700 rounded-md"
            ...
            >
              ...
              <div className="space-y-4">
                ...
                {isCurrentUserHost && (
                  <>
                    ...
                    <button
                      ...
                      className="w-full flex items-center gap-3 p-4 rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 hover:border-blue-500/30 transition-all text-left"
                    >
                    ...
                    <div className="p-4 rounded-xl bg-white/5 border border-white/10">
                      ...
                      <div className="flex gap-2">
                        <button
                          ...
                          className={`flex-1 py-2 rounded-lg text-sm font-medium transition-all ${controlMode === 'host-only' ? 'bg-blue-600 text-white' : 'bg-white/5 text-white/50 hover:bg-white/10'}`}
                        >
                  ...
                  {isCurrentUserHost ? (
                    <div className="grid gap-2 md:grid-cols-2">
                      <button
                        ...
                        className={`rounded-lg px-3 py-3 text-left text-sm font-medium transition-all ${syncMode === 'classic' ? 'bg-blue-600 text-white' : 'bg-white/5 text-white/60 hover:bg-white/10'}`}
                      >
                      ...
                      <button
                        ...
                        className={`rounded-lg px-3 py-3 text-left text-sm font-medium transition-all ${syncMode === 'pro' ? 'bg-blue-600 text-white' : 'bg-white/5 text-white/60 hover:bg-white/10'}`}
                      >
                  ...
                  <div className="p-4 rounded-xl bg-white/5 border border-white/10">
                    ...
                    <div className="flex gap-2">
                      <button
                        ...
                        className={`flex-1 py-2 rounded-lg text-sm font-medium transition-all ${!roomInfo.isPublic ? 'bg-blue-600 text-white' : 'bg-white/5 text-white/50 hover:bg-white/10'}`}
                      >
                ...
                <button
                  ...
                  className="w-full py-3 rounded-xl bg-blue-600/20 border border-blue-500/30 hover:bg-blue-600/30 text-blue-400 text-sm font-medium transition-all"
                >
