    ...
    (node: any, ctx: CanvasRenderingContext2D, globalScale: number) => {
      ...
      if (gNode.img && (gNode.type === 'movie' || gNode.type === 'tv' || gNode.type === 'person')) {
        ...
        if (isHighlighted) {
          ...
          ctx.strokeStyle = gNode.color || '#3b82f6';
          ctx.lineWidth = 3;
          ctx.shadowColor = gNode.color || '#3b82f6';
          ctx.shadowBlur = 20;
          ctx.stroke();
          ctx.shadowBlur = 0;
        }
        ...
        ctx.fillStyle = gNode.color || '#3b82f6';
        ctx.fill();
              ...
              >
                ...
                <div className="p-4 md:p-6 border-b border-white/10 flex justify-between items-center shrink-0">
                  <h3 className="text-lg md:text-xl font-bold text-white flex items-center gap-2">
                    <HelpCircle className="text-blue-500 h-5 w-5 md:h-6 md:w-6" />
                ...
                >
                  ...
                  <div className="flex flex-col gap-3">
                    {[
                      ...
                      { icon: '🖱', title: t('cinegraph.interactTitle'), desc: t('cinegraph.interactDesc') },
          ...
          {showSettings && !settingsClosing && (
            ...
            >
              ...
              >
                ...
                <div className="p-4 md:p-6 border-b border-white/10 flex justify-between items-center shrink-0">
                  <h3 className="text-lg md:text-xl font-bold text-white flex items-center gap-2">
                    <Settings2 className="text-blue-500 h-5 w-5 md:h-6 md:w-6" />
                  ...
                  <div className="flex flex-col gap-4">
                    ...
                    <div className="flex items-center justify-between p-3 rounded-lg bg-white/5 border border-white/5">
                      ...
                      <button
                        ...
                        className={`w-11 h-6 rounded-full transition-colors relative ${graphOptions.actors ? 'bg-blue-600' : 'bg-white/20'}`}
                      >
                    ...
                    <div className="flex items-center justify-between p-3 rounded-lg bg-white/5 border border-white/5">
                      ...
                      <button
                        ...
                        className={`w-11 h-6 rounded-full transition-colors relative ${graphOptions.directors ? 'bg-blue-600' : 'bg-white/20'}`}
                      >
                    ...
                    <div className="flex items-center justify-between p-3 rounded-lg bg-white/5 border border-white/5">
                      ...
                      <button
                        ...
                        className={`w-11 h-6 rounded-full transition-colors relative ${graphOptions.genres ? 'bg-blue-600' : 'bg-white/20'}`}
                      >
                    ...
                    <div className="flex items-center justify-between p-3 rounded-lg bg-white/5 border border-white/5">
                      ...
                      <button
                        ...
                        className={`w-11 h-6 rounded-full transition-colors relative ${graphOptions.similar ? 'bg-blue-600' : 'bg-white/20'}`}
                      >
                    ...
                    <div className="flex items-center justify-between p-3 rounded-lg bg-white/5 border border-white/5">
                      ...
                      <button
                        ...
                        className={`w-11 h-6 rounded-full transition-colors relative ${graphOptions.recommendations ? 'bg-blue-600' : 'bg-white/20'}`}
                      >
                          ...
                          <button
                            ...
                            className={`flex-1 py-1.5 rounded-lg text-sm font-bold transition-all ${
                              graphOptions.depth === d
                                ? 'bg-blue-600 text-white shadow-lg shadow-red-600/30'
