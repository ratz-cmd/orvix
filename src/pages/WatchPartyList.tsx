  ...
  return (
    <SquareBackground squareSize={48} borderColor="rgba(99, 102, 241, 0.10)" className="min-h-screen bg-black text-white">
      ...
      <motion.div
        ...
        className="pt-40 relative z-10 border-b border-white/10 bg-gradient-to-b from-blue-900/10 to-transparent"
      >
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
            ...
            <div className="flex flex-wrap items-center gap-3">
              <AnimatedBorderCard
                ...
                tabIndex={0}
              >
                <Ticket className="h-4 w-4 mr-2 text-white group-hover:text-blue-500 transition-colors" />
      ...
      <div className="container px-6 md:px-10 py-6 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="p-4 rounded-lg bg-white/5 border border-white/5">
              ...
              <p className="text-sm text-white/60">
                {t('watchParty.vipPlayersOnlyDesc')} <Link to="/vip" className="text-blue-400 hover:text-blue-300 hover:underline">{t('watchParty.vipPageLabel')}</Link>
              </p>
            </div>
          </div>
        </motion.div>
        ...
        {isLoading ? (
          ...
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-6 text-center"
          >
