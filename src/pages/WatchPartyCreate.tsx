                ...
                <form onSubmit={handleCreateParty} className="space-y-6">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-white placeholder-white/30 transition-all font-medium"
                      ...
                      <div className="flex bg-white/5 p-1 rounded-lg border border-white/10">
                        <button
                          ...
                          className={`flex-1 flex items-center justify-center gap-2 py-2 px-3 rounded-md text-sm font-medium transition-colors ${!isPublic
                            ? 'bg-blue-600 text-white shadow-lg shadow-red-500/20'
                    ...
                    <div className="grid gap-3 md:grid-cols-2">
                      <button
                        ...
                        className={`rounded-xl border p-4 text-left transition-all ${syncMode === 'classic'
                          ? 'border-blue-500/40 bg-blue-500/10 shadow-lg shadow-red-500/10'
                  ...
                  {sourceGroups.length > 0 && (
                    <div className="rounded-xl border border-white/10 bg-white/5 p-4">
                      ...
                      <div className="mb-4 rounded-xl border border-blue-500/20 bg-blue-500/10 p-3">
                        ...
                        <div className="mt-2 flex items-start justify-between gap-3">
                          ...
                          <Badge variant="default" className="border border-blue-500/30 bg-blue-500/15 text-blue-200 hover:bg-blue-500/20">
                      ...
                      <div className="grid gap-3">
                        {sourceGroups.map((group) => (
                          ...
                          >
                            ...
                            >
                              <SelectTrigger className="h-auto min-h-12 rounded-lg border-white/10 bg-white/5 px-3 py-3 text-sm text-white hover:bg-white/10 focus:ring-blue-500/30">
                                <SelectValue
                                  placeholder={
                  ...
                  <Button
                    ...
                    className="w-full h-12 text-base bg-blue-600 hover:bg-blue-700 text-white border-0 transition-all shadow-lg hover:shadow-red-600/20 hover:scale-[1.02]"
                  >
                    {isCreating ? (
