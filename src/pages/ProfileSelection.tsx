          ...
          >
            ...
            <div className="flex flex-wrap justify-center gap-4 xs:gap-6 sm:gap-8 md:gap-12 mb-8 sm:mb-12">
                ...
                >
                  <div className="relative">
                    ...
                    {(profile.ageRestriction ?? 0) > 0 && (
                      <div className="absolute -bottom-1 -right-1 xs:-bottom-1.5 xs:-right-1.5 bg-blue-600 rounded-full px-1.5 xs:px-2 py-0.5 z-10 flex items-center gap-0.5 shadow-lg shadow-red-600/30">
                  ...
                  {(profile.ageRestriction ?? 0) > 0 && (
                    <p className="text-[10px] xs:text-xs text-blue-400 flex items-center gap-1 mt-0.5">
              ...
              {profiles.length < 5 && (
                ...
                >
                  <div className="w-20 h-20 xs:w-24 xs:h-24 sm:w-28 sm:h-28 md:w-32 md:h-32 lg:w-36 lg:h-36 xl:w-40 xl:h-40 rounded-lg border-2 border-dashed border-gray-600 flex items-center justify-center group-hover:border-blue-600 transition-colors">
