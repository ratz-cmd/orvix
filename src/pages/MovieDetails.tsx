...
const MovieDetails = (): JSX.Element => {
  ...
  useEffect(() => {
    ...
    if (movie) {
      ...
      // Simple movie title
      document.title = `${movie.title} — Orvix | Streaming VF & VOSTFR`;
    } else {
      document.title = 'Film — Orvix';
    }
  }, [movie, id]);
  ...
  const movieYear = movie.release_date && !isNaN(new Date(movie.release_date).getTime())
    ...
    : null;
  const movieTitle = movieYear ? `${movie.title} (${movieYear}) — Orvix | Streaming VF & VOSTFR` : `${movie.title} — Orvix | Streaming VF & VOSTFR`;
  ...
  const movieSocialImage = movie.backdrop_path || movie.poster_path
    ...
    : undefined;
  const movieDescription = movie.overview?.trim() || `Regardez ${movie.title} en streaming HD 1080p VF et VOSTFR sur Orvix.`;
    ...
    <MotionConfig reducedMotion="user">
      ...
      >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      {movie.budget && movie.revenue && movie.budget > 0 && movie.revenue > 0 && (
                        ...
                        >
                          ...
                          <p className={`font-semibold ${movie.revenue - movie.budget > 0 ? 'text-green-400' : 'text-blue-400'}`}>
                        ...
                        >
                          ...
                          <div>
                            ...
                            <div className="grid grid-cols-2 gap-2">
                              ...
                              <div className="bg-gray-900 p-2 rounded-lg">
                                <h5 className="text-xs font-medium text-blue-400 mb-1">{t('details.limitingFactors')}</h5>
                                <ul className="list-disc pl-4 text-xs text-gray-300 space-y-0.5">
                                ...
                                <div className="poster-card">
                                  ...
                                  <img
                                    ...
                                    onError={(e) => {
                                      ...
                                      target.onerror = null;
                                      target.src = 'data:image/svg+xml;utf8,<svg width="500" height="750" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 750" preserveAspectRatio="xMidYMid meet"><rect width="100%" height="100%" fill="%23333"/><text x="50%" y="50%" fill="%23ccc" font-size="50" font-family="Arial, sans-serif" text-anchor="middle" dy=".3em">ORVIX</text></svg>';
                                    }}
                                  />
                                  ...
                                  <div className="hover-content">
                                    ...
                                    <div className="w-full h-24 md:h-28 relative">
                                      <img
                                        ...
                                        onError={(e) => {
                                          const target = e.target as HTMLImageElement;
                                          target.onerror = null;
                                          target.src = 'data:image/svg+xml;utf8,<svg width="500" height="281" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 281" preserveAspectRatio="xMidYMid meet"><rect width="100%" height="100%" fill="%23333"/><text x="50%" y="50%" fill="%23ccc" font-size="30" font-family="Arial, sans-serif" text-anchor="middle" dy=".3em">ORVIX</text></svg>';
                                        }}
                                      />
                                        ...
                                        <button
                                          onClick={(e) => {
                                            ...
                                            if (!exists) {
                                              ...
                                              // Notification
                                              const notification = document.createElement('div');
                                              notification.className = 'fixed top-16 right-4 bg-blue-500 text-white py-2 px-4 rounded shadow-lg z-50 animate-fadeIn';
                                    ...
                                    <div className="p-3 flex flex-col flex-grow">
                                      ...
                                      {part.id === Number(id) && (
                                        <div className="bg-blue-600 text-white text-xs px-2 py-1 rounded-full self-start">
        ...
        >
          ...
          >
            {!isAvailable ? (
              ...
              >
                <motion.div
                  className="w-24 h-24 rounded-full bg-blue-600/80 hover:bg-blue-600 flex items-center justify-center mb-6 cursor-pointer"
                  whileHover={{ scale: 1.1 }}
                  whileTap={{ scale: 0.9 }}
                  onClick={handleWatchClick}
                >
        ...
        {recommendations.length > 0 && (
          ...
          >
            <EmblaCarousel
              title={<span><span className="text-blue-600 mr-2"></span>{t('details.similarMovies')}</span>}
