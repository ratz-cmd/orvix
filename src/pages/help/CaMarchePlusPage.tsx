...
const CaMarchePlusPage: React.FC = () => {
  ...
  useEffect(() => {
    document.title = `${t('help.caMarchePlus.title')} — Orvix`;
  }, [t]);

  const telegramUrl =
    import.meta.env.VITE_SUPPORT_TELEGRAM_URL || 'https://discord.gg/vjt4PRAMBR';
  ...
  const sections: TutoSection[] = [
    {
      ...
      causes: [
        ...
        },
        {
          ...
          ctas: [
            {
              labelKey: 'help.caMarchePlus.cause3CtaOrvixHealth',
              href: 'https://orvix.fr',
              external: true,
            },
            {
              labelKey: 'help.caMarchePlus.cause3CtaRentry',
              href: 'https://rentry.co/orvix',
              external: true,
            },
          ],
        },
  ...
  return (
    <TutoLayout
      icon={<AlertCircle className="w-10 h-10 text-blue-400" />}
