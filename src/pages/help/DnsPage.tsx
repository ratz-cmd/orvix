...
const EXTERNAL_RESOURCES: Array<{
  ...
  { labelKey: 'helpDns.otherMirrorsOrvixHealth', href: 'https://orvix.fr' },
  { labelKey: 'helpDns.otherMirrors', href: 'https://rentry.co/orvix' },
  {
...
const DnsPage: React.FC = () => {
  ...
  useEffect(() => {
    document.title = `${t('helpDns.title')} — Orvix`;
  }, [t]);
      ...
      {INSTALL_TARGETS.map((target) => (
        ...
        >
          <div className="flex items-center gap-2 mb-2 text-white">
            <span className="text-blue-400">{target.icon}</span>
