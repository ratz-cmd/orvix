                                            ...
                                            {limitStatus && (
                                                ...
                                                >
                                                    <div className={`inline-flex items-center gap-2 px-4 py-2 rounded-full text-sm font-medium border ${limitStatus.remaining === 0
                                                        ? 'bg-blue-500/10 border-blue-500/50 text-blue-400 shadow-[0_0_20px_-5px_rgba(239,68,68,0.3)]'
                                        ...
                                        {contentType === 'season' && selectedContent && seasons.length > 0 && (
                                            ...
                                            >
                                                ...
                                                <div
                                                    ...
                                                    className={`mb-4 p-4 rounded-xl border cursor-pointer transition-all ${selectedSeasons.includes(0) ? 'bg-blue-500/20 border-blue-500/50' : 'bg-white/5 border-white/10 hover:border-white/20'}`}
                                                >
                                                    <div className="flex items-center gap-3">
                                                        <div className={`w-5 h-5 rounded border-2 flex items-center justify-center ${selectedSeasons.includes(0) ? 'bg-blue-500 border-blue-500' : 'border-white/30'}`}>
                                                ...
                                                <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 gap-3">
                                                    {seasons.map((season) => (
                                                        <div
                                                            ...
                                                            className={`p-4 rounded-xl border cursor-pointer transition-all text-center ${selectedSeasons.includes(season) ? 'bg-blue-500/20 border-blue-500/50' : 'bg-white/5 border-white/10 hover:border-white/20 hover:bg-white/10'}`}
                                                        >
                                                            <div className={`w-5 h-5 mx-auto mb-2 rounded border-2 flex items-center justify-center ${selectedSeasons.includes(season) ? 'bg-blue-500 border-blue-500' : 'border-white/30'}`}>
                                    ...
                                    >
                                        <div className="w-full">
                                            ...
                                            <div className="space-y-6">
                                                ...
                                                {error && (
                                                    <div className="text-blue-400 text-sm bg-blue-500/10 p-4 rounded-lg border border-blue-500/20 flex items-center gap-3">
