...
const SubmitLinkPage: React.FC = () => {
    ...
    const statusColors: Record<string, string> = {
        ...
        rejected: 'bg-blue-500/20 text-blue-400',
    };
                ...
                <div className="mb-8">
                    ...
                    {limitStatus && (
                        <div className="flex flex-wrap justify-center gap-3 mt-4">
                            <span className={`inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-medium ${limitStatus.movies.remaining > 0 ? 'bg-green-500/10 text-green-400 border border-green-500/20' : 'bg-blue-500/10 text-blue-400 border border-blue-500/20'}`}>
                            ...
                            <span className={`inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-medium ${limitStatus.series.remaining > 0 ? 'bg-green-500/10 text-green-400 border border-green-500/20' : 'bg-blue-500/10 text-blue-400 border border-blue-500/20'}`}>
                                ...
                                >
                                    ...
                                    {error && (
                                        <motion.div
                                            initial={{ opacity: 0, y: -5 }}
                                            animate={{ opacity: 1, y: 0 }}
                                            className="mb-4 p-3 rounded-xl bg-blue-500/10 border border-blue-500/20 text-sm text-blue-400 flex items-center gap-2"
                                        >
