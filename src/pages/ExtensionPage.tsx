...
const supportedHostersData = [
  ...
  { name: 'DoodStream', descKey: 'extension.hosterDoodDesc', color: '#3b82f6' },
...
const installTutorial = {
  ...
  actions: [
    ...
    { href: USERSCRIPT_INSTALL_URL, labelKey: 'extension.installOrvixUserscript', variant: 'primary' as const },
  ],
};

type OrvixExtensionWindow = Window & {
...
const ExtensionPage: React.FC = () => {
  ...
  useEffect(() => {
    const checkExtension = () => {
      const orvixWindow = window as any;
              ...
              <div className="grid md:grid-cols-2 gap-8">
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <h3 className="text-lg font-semibold text-blue-400">{t('extension.withoutExtension')}</h3>
                  </div>
                  <div className="space-y-3">
                    <div className="flex items-start gap-3 p-3 rounded-lg bg-white/5 border border-blue-500/10">
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-2 mt-1">
                          ...
                          <span className="text-xs text-blue-400">{t('extension.diagramServerRequest')}</span>
                          <div className="h-px flex-1 bg-blue-500/30" />
                        </div>
                      </div>
                    </div>
                    <div className="flex items-start gap-3 p-3 rounded-lg bg-white/5 border border-blue-500/10">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-blue-400 mt-1">{t('extension.diagramDiffIP')}</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3 p-3 rounded-lg bg-blue-500/10 border border-blue-500/20">
                      <Lock className="w-5 h-5 text-blue-500 mt-0.5 flex-shrink-0" />
                      <div>
                        <p className="text-sm text-blue-300 font-medium">{t('extension.diagramBlocked')}</p>
                        <p className="text-xs text-blue-400/70 mt-1">{t('extension.diagramBlockedReason')}</p>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        >
          ...
          >
            ...
            >
              ...
              <a
                href={ORVIX_OPEN_SOURCE_GITHUB_URL}
                target="_blank"
                rel="noopener noreferrer"
        ...
        >
          ...
          >
            ...
            <div className="flex flex-col items-center justify-center gap-3 w-full">
              ...
              <a href={ORVIX_OPEN_SOURCE_GITHUB_URL} target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto">
