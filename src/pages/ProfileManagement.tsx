...
const ProfileManagement: React.FC = () => {
  ...
  const ageRestrictionOptions = [
    ...
    { value: 18, label: '18+', color: 'text-blue-400' },
  ];
              ...
              {profiles.map((profile) => (
                ...
                >
                  <div className="relative group">
                    <div className="w-20 h-20 xs:w-24 xs:h-24 sm:w-28 sm:h-28 md:w-32 md:h-32 lg:w-36 lg:h-36 xl:w-40 xl:h-40 rounded-lg overflow-hidden ring-2 xs:ring-4 ring-transparent group-hover:ring-blue-600 transition-all duration-300">
                      <img
                        src={profile.avatar}
                        alt={profile.name}
                    ...
                    {(profile.ageRestriction ?? 0) > 0 && (
                      <div className="absolute -bottom-0.5 -right-0.5 xs:-bottom-1 xs:-right-1 bg-blue-600 rounded-full px-1 xs:px-1.5 py-0.5 z-10 flex items-center gap-0.5">
                  ...
                  <div className="mt-2 xs:mt-3 sm:mt-4 w-full max-w-xs">
                    ...
                    {(profile.ageRestriction ?? 0) > 0 && (
                      <p className="text-[10px] xs:text-xs text-blue-400 text-center mt-0.5 flex items-center justify-center gap-1">
              ...
              {profiles.length < 5 && (
                ...
                >
                  <div className="relative">
                    <div className="w-20 h-20 xs:w-24 xs:h-24 sm:w-28 sm:h-28 md:w-32 md:h-32 lg:w-36 lg:h-36 xl:w-40 xl:h-40 rounded-lg border-2 border-dashed border-gray-600 flex items-center justify-center group-hover:border-blue-600 transition-colors cursor-pointer"
                      onClick={handleOpenCreate}
                    >
                      <Plus className="w-6 h-6 xs:w-8 xs:h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 text-gray-400 group-hover:text-blue-600 transition-colors" />
                    </div>
                  </div>
               ...
               <div className="text-center">
                 ...
                 <div className="flex gap-3">
                   ...
                   <motion.button
                     ...
                     className="flex-1 px-4 py-2 border border-blue-600 rounded-lg hover:border-blue-500 transition-colors"
                   >
                     {t('common.delete')}
                   </motion.button>
                 </div>
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <div className="flex flex-col items-center">
                  ...
                  <div className="relative">
                    <motion.div
                      whileHover={{ scale: 1.05 }}
                      whileTap={{ scale: 0.95 }}
                      className="w-28 h-28 sm:w-32 sm:h-32 rounded-full overflow-hidden cursor-pointer border-2 border-gray-600 hover:border-blue-600 transition-colors"
                    ...
                    {modalAgeRestriction > 0 && (
                      <div className="absolute -bottom-2 -right-2 bg-blue-600 rounded-full px-2.5 py-1 z-10 flex items-center gap-1 shadow-lg shadow-red-600/40">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full p-3 bg-gray-800 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-600"
                    maxLength={20}
                  />
                </div>
                ...
                <div>
                  ...
                  <div className="relative" ref={dropdownRef}>
                    <button
                      ...
                      className="w-full p-3 bg-gray-800 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-blue-600 flex items-center justify-between cursor-pointer hover:bg-gray-750 transition-colors"
                    >
              ...
              <div className="flex flex-col sm:flex-row gap-3 mt-6">
                ...
                {!isCreating && (
                  <motion.button
                    ...
                    className="flex-1 px-4 py-2 border border-blue-600 rounded-lg hover:border-blue-500 disabled:border-gray-600 disabled:cursor-not-allowed transition-colors"
                  >
                    {t('common.delete')}
                  </motion.button>
                )}
