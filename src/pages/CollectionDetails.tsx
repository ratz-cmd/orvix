            ...
            <div className="flex flex-col lg:flex-row gap-8 mb-12">
              ...
              <div className="flex-1">
                <motion.h1 initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="text-4xl lg:text-6xl font-black tracking-tight mb-4">
                  <ShinyText text={collection.name} speed={3} color="#ffffff" shineColor="#3b82f6" className="leading-tight" />
                </motion.h1>
            ...
            <div>
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8 gap-4">
                <h2 className="text-2xl sm:text-3xl font-bold">
                  <ShinyText text={t('collections.movies')} speed={2} color="#ffffff" shineColor="#3b82f6" />
                </h2>
              ...
              {viewMode === 'grid' && (
                <motion.div variants={containerVariants} initial="hidden" whileInView="visible" viewport={{ once: true, margin: '-50px' }} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                  {displayedMovies.map((movie, index) => (
                    ...
                    <div
                      className="bg-white/[0.03] rounded-xl overflow-hidden border border-white/10 hover:border-blue-500/30 transition-all duration-300 group cursor-pointer hover:bg-white/[0.06]"
                    >
                      <Link to={`/movie/${encodeId(movie.id)}`} className="block">
                        <div className="relative">
                          ...
                          <div className="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                            <div className="bg-blue-600 hover:bg-blue-700 rounded-full p-3 transition-colors">
                              <Info size={20} />
                            </div>
                          </div>
              ...
              {viewMode === 'list' && (
                <motion.div variants={containerVariants} initial="hidden" whileInView="visible" viewport={{ once: true, margin: '-50px' }} className="space-y-4">
                  {displayedMovies.map((movie, index) => (
                    <motion.div key={movie.id} variants={itemVariants}>
                    <div
                      className="bg-white/[0.03] rounded-xl border border-white/10 hover:border-blue-500/30 transition-all duration-300 group cursor-pointer hover:bg-white/[0.06]"
                    >
                      <Link to={`/movie/${encodeId(movie.id)}`} className="block">
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex items-start justify-between">
                              ...
                              <div className="flex-shrink-0 ml-4 opacity-0 group-hover:opacity-100 transition-opacity">
                                <div className="bg-blue-600 hover:bg-blue-700 rounded-full p-2 transition-colors">
                                  <Info size={16} />
                                </div>
                              </div>
                            </div>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="container mx-auto px-4 py-8 relative z-10">
          <div>
            <h2 className="text-2xl sm:text-3xl font-bold mb-8 flex items-center gap-3">
              ...
              <ShinyText text={t('collections.globalStats')} speed={2} color="#ffffff" shineColor="#3b82f6" />
            </h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                {collectionStats.totalBudget > 0 && collectionStats.totalRevenue > 0 && (
                  <div className="col-span-full">
                    <AnimatedBorderCard highlightColor="239 68 68" backgroundColor="12 12 12" className="p-6">
                      <div className="flex items-center gap-3 mb-3">
                        <TrendingUp className={collectionStats.profitMargin > 0 ? "text-green-400" : "text-blue-400"} size={24} />
                        <h3 className="text-lg font-semibold">{t('collections.profitLoss')}</h3>
                      </div>
                      <p className={`text-2xl font-bold ${collectionStats.profitMargin > 0 ? 'text-green-400' : 'text-blue-400'}`}>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="container mx-auto px-4 py-8 relative z-10">
          <div>
            <h2 className="text-2xl sm:text-3xl font-bold mb-8 flex items-center gap-3">
              ...
              <ShinyText text={t('collections.productionInfo')} speed={2} color="#ffffff" shineColor="#3b82f6" />
            </h2>
          ...
          <div className="container mx-auto px-4">
            <div>
              <h2 className="text-2xl sm:text-3xl font-bold mb-8">
                <ShinyText text={t('collections.similarCollections')} speed={2} color="#ffffff" shineColor="#3b82f6" />
              </h2>
