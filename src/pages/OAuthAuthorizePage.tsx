...
const ORVIX_LOGO_SRC = '/orvix.png';
...
function getStoredIdentity(): StoredIdentity | null {
  ...
  if (authRaw) {
    try {
      ...
      if (userProfile && typeof userProfile === 'object') {
        return {
          username: String(userProfile.username || userProfile.name || 'Orvix'),
  ...
  if (googleRaw) {
    try {
      ...
      return {
        username: String(parsed?.name || 'Orvix'),
  ...
  if (discordRaw) {
    try {
      ...
      return {
        username: String(parsed?.username || 'Orvix'),
  ...
  return (
    <div>
      <p className="text-[0.6rem] font-semibold uppercase tracking-[0.3em] text-gray-400">
        🚫 {t('oauthAuthorize.fakeNotRequestedTitle', 'Ce que Orvix ne demande pas')}
      </p>
      <div className="mt-2 flex items-start gap-2.5">
        <span className="mt-0.5 shrink-0 text-blue-400/70 leading-none">✗</span>
  ...
  return (
    <div>
      <button
        ...
        className="flex w-full items-center justify-between gap-2 rounded-lg py-1 text-left transition-colors hover:opacity-80 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500/40"
      >
            ...
            <div className="mt-2 grid gap-1.5 sm:grid-cols-2">
              {requestedScopes.map((scopeItem) => {
                ...
                return (
                  ...
                  >
                    <Icon className="h-3.5 w-3.5 shrink-0 text-blue-300" />
...
const OAuthAuthorizePage: React.FC = () => {
  ...
  const displayName = currentProfile?.name || accountIdentity?.username || 'Orvix';
      ...
      <div className="mx-auto w-full max-w-5xl px-4 py-6 sm:px-6 sm:py-10">
        ...
        >
          <section className="min-w-0 rounded-3xl border border-white/10 bg-white/[0.04] p-5 shadow-xl backdrop-blur sm:p-7">
            <div className="flex items-start justify-between gap-3">
              <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3 py-1.5">
                <img src={ORVIX_LOGO_SRC} alt="Orvix" className="h-4 w-4 object-contain" />
                <span className="text-xs font-medium text-white">Orvix OAuth</span>
              </div>
            ...
            <div className="mt-5 space-y-2">
              <p className="text-[0.65rem] font-semibold uppercase tracking-[0.3em] text-blue-300/80">
            ...
            {isLoading ? (
              ...
              <div className="mt-6 rounded-2xl border border-blue-500/30 bg-blue-500/10 p-4 text-sm text-blue-100">
                ...
                <p className="mt-2 text-blue-100/80">{error}</p>
                ...
                <Link to="/" className="mt-3 inline-flex items-center gap-2 text-sm font-medium text-blue-200 hover:text-white">
                  ...
                  <div className="space-y-4 border-t border-white/10 pt-5">
                    ...
                    <div className="flex flex-col-reverse gap-2 sm:flex-row sm:justify-end">
                      ...
                      <Button
                        ...
                        disabled={isSubmitting}
                        className="bg-blue-600 hover:bg-blue-700 sm:w-auto sm:min-w-[10rem]"
                      >
          ...
          <aside className="min-w-0 rounded-3xl border border-white/10 bg-white/[0.02] p-5 shadow-xl backdrop-blur sm:p-6">
            <p className="text-[0.6rem] font-semibold uppercase tracking-[0.3em] text-gray-400">
              {isAlreadyConnected ? t('oauthAuthorize.connectedAccount') : t('oauthAuthorize.connectOrvix')}
            </p>
            {isAlreadyConnected ? (
              <>
                ...
                <Button
                  ...
                  disabled={!preview}
                  className="mt-4 w-full justify-center bg-blue-600 hover:bg-blue-700"
                >
              ...
              <>
                ...
                <div className="mt-5 space-y-2.5">
                  ...
                  >
                    {t('oauthAuthorize.createOrvixAccount')}
                  </Button>
                </div>
              </>
            )}
