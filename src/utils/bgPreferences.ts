...
export const BG_ACCENT_PRESETS = {
  red:     { rgb: '239, 68, 68',    label: 'Rouge',    swatch: '#3b82f6' },
...
export const BG_PREFS_EVENT = 'orvix:bg-prefs-changed';
...
export function readBgPrefs(): BgPrefs {
  ...
  const customHex = (typeof window === 'undefined' ? null : localStorage.getItem(BG_STORAGE_KEYS.customHex)) || '#3b82f6';
