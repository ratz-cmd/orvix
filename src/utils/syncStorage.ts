...
export const SYNC_OUTBOX_STORAGE_KEY = '__orvix_sync_outbox';
export const LEGACY_SYNC_OUTBOX_STORAGE_KEY = '__orvix_sync_outbox';

const BLOCKED_SYNC_KEYS = new Set([
  SYNC_OUTBOX_STORAGE_KEY,
  LEGACY_SYNC_OUTBOX_STORAGE_KEY,
  'access_token',
  'auth',
  'auth_method',
  'auth_token',
