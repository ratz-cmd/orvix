...
# Miroirs injectés dans sw.js / sitemap.xml / robots.txt par vite.config.ts.
# Sans ces ARG, un déploiement Coolify gardait les valeurs par défaut du code
# même si les variables étaient définies côté plateforme.
ARG VITE_DEFAULT_MIRRORS
ARG VITE_MIRRORS_CONFIG_URL
